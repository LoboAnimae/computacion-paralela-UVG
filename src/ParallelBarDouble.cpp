/**
 * ParallelBarDouble.cpp
 * Even more efficient than ParallelBarSimulation!
 * Uses double instead of long double for calculations
 * **/
...
int main(int argc, char* argv[]) {
    ...
    double ldp_temperatures_old[n];
    double ldp_temperatures_new[n];
